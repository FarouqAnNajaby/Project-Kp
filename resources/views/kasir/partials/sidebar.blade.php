<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ request()->routeIs('kasir.laporan_umkm.index') ? 'active' : null }}">
                <a href="{{ route('kasir.laporan_umkm.index') }}" class="nav-link"><i class="far fa-file-alt"></i> <span>Laporan UMKM</span></a>
            </li>

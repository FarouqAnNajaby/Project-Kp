...
<section class="section">
    <x-admin-breadcrumb backBtn=true title="Tambah Data Kasir" backUrl="{{ route('admin.list-admin-kasir.kasir.index') }}">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        {!! Form::open(['route' => 'admin.list-admin-kasir.kasir.store']) !!}

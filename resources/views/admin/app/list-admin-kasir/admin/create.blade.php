...
<section class="section">
    <x-admin-breadcrumb backBtn=true title="Tambah Data Admin" backUrl="{{ route('admin.list-admin-kasir.admin.index') }}">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        {!! Form::open(['route' => 'admin.list-admin-kasir.admin.store']) !!}

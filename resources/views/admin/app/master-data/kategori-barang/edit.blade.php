...
<section class="section">
    <x-admin-breadcrumb backBtn=true title="Edit Kategori Barang" url="{{ route('admin.master-data.kategori-barang.index') }}">
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row mb-4">
                            {!! Form::label('is_dropdown', 'Dropdown E-Commerce', ['class' => 'col-form-label text-md-right col-12 col-md-3 col-lg-3']) !!}
                            <div class="col-sm-12 col-md-7">

...
<section class="section">
	<x-admin-breadcrumb addBtn=true title="Banner" url="{{ route('admin.master-data.banner.create') }}">
		<x-slot name="breadcrumbItem">
			<div class="breadcrumb-item">Data Kategori Banner</div>
		</x-slot>
	</x-admin-breadcrumb>

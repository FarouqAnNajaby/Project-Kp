...
<section class="section">
    <x-admin-breadcrumb backBtn=true title="Banner E-Commerce" backUrl="{{ route('admin.master-data.banner.index') }}">
        <x-slot name="breadcrumbItem">
            ...
            <div class="breadcrumb-item">
                <a href="{{ route('admin.master-data.banner.create') }}">Tambah Banner E-Commerce</a>
            </div>
        </x-slot>
    </x-admin-breadcrumb>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row mb-4">
                            {!! Form::label('deskripsi', 'Deskripsi Banner* <i class="fas fa-info-circle" data-toggle="tooltip" title="Minimal 20 huruf & maksimal 100 huruf."></i>', ['class' => 'col-form-label text-md-right col-12 col-md-3 col-lg-3'], false) !!}
                            <div class="col-sm-12 col-md-7">
                                {!! Form::textarea('deskripsi', null, ['class' => 'form-control' . ($errors->has('deskripsi') ? ' is-invalid' : null), 'required']) !!}
                                @error('deskripsi')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>

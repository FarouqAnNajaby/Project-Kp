...
<section class="section">
	<x-admin-breadcrumb backBtn=true title="Data Banner" url="{{ route('admin.master-data.banner.index') }}">
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="form-group row mb-4">
							...
							<div class="col-sm-12 col-md-7">
								{!! Form::text('judul', null, ['class' => 'form-control' . ($errors->has('judul') ? ' is-invalid' : null), 'required']) !!}
								@error('judul')

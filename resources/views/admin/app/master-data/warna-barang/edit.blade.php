...
<section class="section">
	<x-admin-breadcrumb backBtn=true title="Edit Warna Barang" url="{{ route('admin.master-data.warna-barang.index') }}">
		<x-slot name="breadcrumbItem">
			<div class="breadcrumb-item">Master Data</div>
			<div class="breadcrumb-item"><a href="{{ route('admin.master-data.warna-barang.index') }}">Data Warna Barang</a></div>
			<div class="breadcrumb-item"><a>Edit Warna Barang</a></div>
		</x-slot>
	</x-admin-breadcrumb>
		...
		<div class="row">
			<div class="col-12">
				<div class="card">
					...
					<div class="card-body">
						{!! Form::model($data, ['route' => ['admin.master-data.warna-barang.update', $data->uuid], 'method' => 'patch']) !!}
